"""
Django settings for healthcakes_project project.
"""
...
CUSTOM_ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS")
...
ROOT_URLCONF = 'healthcakes_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # needed for active menu highlighting
...
WSGI_APPLICATION = 'healthcakes_project.wsgi.application'
